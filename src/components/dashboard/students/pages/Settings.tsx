    ...
    <div className="p-6 md:p-8 text-gray-800 dark:text-gray-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-10 mt-10 md:gap-6 items-center w-full">
        ...
        <form className="p-4 flex flex-col gap-6 w-full rounded-lg col-span-7">
          ...
          <div className="flex flex-col gap-4">
            <label className="text-gray-600 dark:text-gray-300" htmlFor="email">
              Email
            </label>
            <input placeholder="Email Address" className="input-field" type="email" id="email" />
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <input placeholder="Profile Title" className="input-field" type="text" id="title" />
          </div>
