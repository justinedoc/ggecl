    ...
    <div className="p-2 md:p-8">
        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <select className="w-full sm:w-auto pl-3 pr-10 py-2 border border-gray-300 dark:border-gray-700 bg-transparent rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500">
            ...
            <option className="bg-gray-200 dark:bg-gray-900">Marketing</option>
          </select>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-8">
        {currentCourses.map((course) => (
          <div key={course.id} className="relative border border-gray-200 dark:border-gray-800 shadow-md rounded-lg overflow-hidden">
            ...
            <div className="p-4">
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <button
                  className={`flex items-center justify-center gap-2 py-2 px-4 rounded-md font-semibold text-white transition-all ${course.progress === 100 ? "btn w-full" : "bg-gray-800 hover:bg-gray-700"}`}
                >
                  {course.progress === 100 ? "Watch Again" : "Continue Lecture"}
                </button>
                {course.progress !== 100 && (
                  <div className="text-gray-600 dark:text-gray-400 text-sm">{course.progress}% completed</div>
                )}
              </div>
